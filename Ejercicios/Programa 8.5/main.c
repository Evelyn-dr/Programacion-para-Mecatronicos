...
void main(void)
{
    ...
    printf("Alumno 3\n");
    Lectura(&a3); /* Se llama a una funcion para leer los campos de la variable a3. */ /* Impresion de resultados. */
    printf("\nDatos del alumno 1\n");
    printf("%d\n", a1.matricula);
    puts(a1.nombre);
    puts(a1.carrera);
    ...
    /* Si tratamos de imprimir el campo correo, escribira basura. */
    strcpy(a1.personales.correo, "hgimenez@hotmail.com");
    /* Se ingresa ahora un valor al segundo campo de la union de la variable a0. */
    puts(a1.personales.celular);
    /* Ahora escribira basura en el campo del telefono celular. */
    puts(a1.personales.correo);
    /* Escribira el contenido del campo (hgimenez@hotmail.com). */
    printf("\nDatos del alumno 2\n");
    printf("%d\n", a2.matricula);
    puts(a2.nombre);
    puts(a2.carrera);
    printf("%.2f\n", a2.promedio);
    puts(a2.personales.celular); /* Escribira basura. */
    puts(a2.personales.correo); /* Escribira el contenido del segundo campo. */
    printf("Ingrese el telefono celular del alumno 2: ");
    fflush(stdin);
    gets(a2.personales.celular);
    puts(a2.personales.celular); /* Escribira el telefono celular ingresado. */
    puts(a2.personales.correo); /* Ahora escribira basura. */
    printf("\nDatos del alumno 3\n");
    printf("%d\n", a3.matricula);
    puts(a3.nombre);
    puts(a3.carrera);
    ...
    puts(a3.personales.correo); /* Escribira basura. */
}
