...
/* Esta funcion se utiliza para leer un arreglo unidimensional de tipo propiedades de T elementos. */
{
    int I;
    for (I=0; I<T; I++)
    {
...
/* Esta funcion se utiliza para generar un listado de las propiedades disponibles para venta en la zona de Miraflores, cuyo valor oscila entre 450,000 y 650,000 nuevos soles. */
{
    int I;
